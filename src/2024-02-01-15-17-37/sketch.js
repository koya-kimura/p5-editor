...
function setup() {
  ...
  for(let y = 0; y < height; y += h){
    ...
    let gradientCircleFill = drawingContext.createLinearGradient(
      x,
      y-s,
      x,
      y
    ...
    gradientCircleFill.addColorStop(0, color(100, 255, 100));
    gradientCircleFill.addColorStop(1, color(20, 20, 20));

    drawingContext.fillStyle = gradientCircleFill;

    ovalCircle(x, y, s);

    let gradientRectFill = drawingContext.createLinearGradient(
      width * 0.5,
      0,
      width * 0.5,
      height
    ...
    gradientRectFill.addColorStop(0, color(54, 31, 17));
    gradientRectFill.addColorStop(1, color(24, 11, 7));

    drawingContext.fillStyle = gradientRectFill;
